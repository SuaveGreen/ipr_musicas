...
export const musicas: MusicaItem[] = [
  ...
  { id: 238, musica: 'Único', cantor: 'Marco Telles', linkYoutube: 'https://youtu.be/0vCmIKyJPRI', tom: "G" },
  ...
  { id: 253, musica: 'Tudo é Perda', cantor: 'Felipe Rodrigues', linkYoutube: '' },

  // { id: 254, musica: '', cantor: '', linkYoutube: '' },
